	...
	<div class="col-sm-12">
		<article class="content">
			<div class="form">
                ...
                <?= $this->Form->create('',['url' => ['controller' => 'ShopRegists', 'action' => 'confirm']]) ?>

                <fieldset>

                    <legend><?= $shopname ?>
                    <?php if($this->request->getParam('action') === 'option2') echo ' STEP3/3' ?>
                    </legend>
                        <label>営業時間</label>
...
<?php endfor; //営業時間の出力終了?>
                    ...
                    <?= $this->Form->create('',['class'=>'prev' , 'url' => ['action' => 'addresscheck']]) ?>
